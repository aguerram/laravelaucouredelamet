@extends('layouts.app')
@section('title')
    Ajouter un projet professionnel
@endsection
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <nav class="breadcrumb">
                    ...
                    <span class="breadcrumb-item active">Ajouter un projet professionnel</span>
                </nav>
            </div>
            <div class="col-md-8 col-12 card pt-3">
                ...
                @endif
                <form class="col-12" method="post" action="/proproject" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="">Titre</label>
                        <input required type="text" name="title" id="" class="form-control" placeholder=""
                               aria-describedby="helpId" value="{{old('title')}}">
                        <small id="helpId" class="text-muted">Tire de votre projet professionnel</small>
                    </div>
