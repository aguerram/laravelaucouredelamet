            ...
            <div class="col-md-8 col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <span>Mes projets entrepreneurials</span>
                        <a href="/entrproject/create" class="btn btn-primary"><i class="fa fa-plus"></i> Ajouter un
                            projet entrepreneurial</a>
                    </div>
                        ...
                        @foreach($projects as $prjt)
                            <div class="media mb-4">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="btn-group">
                                        <a href="/entrproject/{{$prjt->id}}" class="readmore btn btn-sm btn-secondary">Lire
                                            la suite</a>&nbsp;&nbsp;&nbsp;
                                        <a href="/entrproject/{{$prjt->id}}/edit" class="btn btn-success btn-sm"><i
                                        ...
                                        <div class="dropdown open">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="triggerId">
                                                <form method="post" action="/entrproject/{{$prjt->id}}">
                                                    @csrf
                                                    @method('DELETE')
