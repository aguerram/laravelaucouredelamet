...
@section('content')
    <div class="row">
        <div class="col pb-5">
            <h2>Modifier le projet entrepreneurial</h2>
            <div class="row justify-content-center">
                <form action="/admin/{{Request::segment(2)}}/{{$project->id}}" method="post" class="col-12 col-md-8" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="body">{{$project->body}}</textarea>
                            </div>
                            <div class="form-group">
